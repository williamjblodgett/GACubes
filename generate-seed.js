...
const listings = [
  ...
  // ============================================================
  // NEW METRO ATLANTA LOCATIONS (100)
  // ============================================================

  // === ICE VENDING (~40) ===
  // Twice the Ice
  {n:"Twice the Ice - Sandy Springs",a:"6025 Roswell Rd",c:"Sandy Springs",z:"30328",la:33.935,ln:-84.365,cp:"ice-vending",cs:["water-refill"],sn:"Twice the Ice"},
  {n:"Twice the Ice - Dunwoody",a:"4555 Ashford Dunwoody Rd",c:"Dunwoody",z:"30338",la:33.929,ln:-84.335,cp:"ice-vending",cs:["water-refill"],sn:"Twice the Ice"},
  {n:"Twice the Ice - Roswell Crossroads",a:"1175 Woodstock Rd",c:"Roswell",z:"30075",la:34.035,ln:-84.395,cp:"ice-vending",cs:["water-refill"],sn:"Twice the Ice"},
  {n:"Twice the Ice - Alpharetta Milton",a:"12650 Crabapple Rd",c:"Alpharetta",z:"30004",la:34.097,ln:-84.318,cp:"ice-vending",cs:["water-refill"],sn:"Twice the Ice"},
  {n:"Twice the Ice - Johns Creek",a:"10990 State Bridge Rd",c:"Johns Creek",z:"30022",la:34.030,ln:-84.198,cp:"ice-vending",cs:["water-refill"],sn:"Twice the Ice"},
  {n:"Twice the Ice - Suwanee",a:"3380 Lawrenceville-Suwanee Rd",c:"Suwanee",z:"30024",la:34.050,ln:-84.072,cp:"ice-vending",cs:["water-refill"],sn:"Twice the Ice"},
  {n:"Twice the Ice - Lilburn",a:"4280 Lawrenceville Hwy",c:"Lilburn",z:"30047",la:33.882,ln:-84.126,cp:"ice-vending",cs:[],sn:"Twice the Ice"},
  {n:"Twice the Ice - Stone Mountain",a:"5250 Memorial Dr",c:"Stone Mountain",z:"30083",la:33.802,ln:-84.195,cp:"ice-vending",cs:["water-refill"],sn:"Twice the Ice"},
  {n:"Twice the Ice - Tucker",a:"4360 LaVista Rd",c:"Tucker",z:"30084",la:33.852,ln:-84.237,cp:"ice-vending",cs:[],sn:"Twice the Ice"},
  {n:"Twice the Ice - Lithonia",a:"6859 Main St",c:"Lithonia",z:"30058",la:33.713,ln:-84.105,cp:"ice-vending",cs:[],sn:"Twice the Ice"},
  {n:"Twice the Ice - Clarkston",a:"3850 Market St",c:"Clarkston",z:"30021",la:33.810,ln:-84.240,cp:"ice-vending",cs:[],sn:"Twice the Ice"},
  {n:"Twice the Ice - Jonesboro",a:"6928 Tara Blvd",c:"Jonesboro",z:"30236",la:33.522,ln:-84.353,cp:"ice-vending",cs:["water-refill"],sn:"Twice the Ice"},
  {n:"Twice the Ice - East Point",a:"2855 Main St",c:"East Point",z:"30344",la:33.677,ln:-84.439,cp:"ice-vending",cs:[],sn:"Twice the Ice"},
  {n:"Twice the Ice - Mableton",a:"5920 Mableton Pkwy",c:"Mableton",z:"30126",la:33.814,ln:-84.567,cp:"ice-vending",cs:["water-refill"],sn:"Twice the Ice"},
  {n:"Twice the Ice - Austell",a:"5740 Austell Rd",c:"Austell",z:"30106",la:33.815,ln:-84.640,cp:"ice-vending",cs:[],sn:"Twice the Ice"},
  {n:"Twice the Ice - Lithia Springs",a:"1900 Lee Rd",c:"Lithia Springs",z:"30122",la:33.785,ln:-84.672,cp:"ice-vending",cs:[],sn:"Twice the Ice"},
  {n:"Twice the Ice - Stockbridge Hwy 138",a:"5070 N Henry Blvd",c:"Stockbridge",z:"30281",la:33.542,ln:-84.228,cp:"ice-vending",cs:["water-refill"],sn:"Twice the Ice"},
  {n:"Twice the Ice - Hampton",a:"1295 Bear Creek Blvd",c:"Hampton",z:"30228",la:33.386,ln:-84.284,cp:"ice-vending",cs:[],sn:"Twice the Ice"},
  {n:"Twice the Ice - Locust Grove",a:"4949 Bill Gardner Pkwy",c:"Locust Grove",z:"30248",la:33.349,ln:-84.111,cp:"ice-vending",cs:["water-refill"],sn:"Twice the Ice"},
  {n:"Twice the Ice - Ellenwood",a:"3995 Panthersville Rd",c:"Ellenwood",z:"30294",la:33.631,ln:-84.306,cp:"ice-vending",cs:[],sn:"Twice the Ice"},
  // Kooler Ice
  {n:"Kooler Ice - Woodstock",a:"7310 Hwy 92",c:"Woodstock",z:"30189",la:34.098,ln:-84.527,cp:"ice-vending",cs:["water-refill"],sn:"Kooler Ice"},
  {n:"Kooler Ice - Acworth Lake",a:"4500 Cherokee St",c:"Acworth",z:"30101",la:34.064,ln:-84.678,cp:"ice-vending",cs:["water-refill"],sn:"Kooler Ice"},
  {n:"Kooler Ice - Winder",a:"259 E May St",c:"Winder",z:"30680",la:33.993,ln:-83.717,cp:"ice-vending",cs:[],sn:"Kooler Ice"},
  {n:"Kooler Ice - Monroe",a:"770 N Broad St",c:"Monroe",z:"30655",la:33.800,ln:-83.715,cp:"ice-vending",cs:["water-refill"],sn:"Kooler Ice"},
  {n:"Kooler Ice - Social Circle",a:"1050 N Cherokee Rd",c:"Social Circle",z:"30025",la:33.660,ln:-83.718,cp:"ice-vending",cs:[],sn:"Kooler Ice"},
  // Ice House America
  {n:"Ice House America - Vinings",a:"3100 Paces Mill Rd",c:"Atlanta",z:"30339",la:33.865,ln:-84.470,cp:"ice-vending",cs:["water-refill"],sn:"Ice House America"},
  {n:"Ice House America - Buckhead",a:"3655 Roswell Rd NE",c:"Atlanta",z:"30305",la:33.852,ln:-84.383,cp:"ice-vending",cs:["water-refill"],sn:"Ice House America"},
  {n:"Ice House America - Midtown",a:"1060 W Peachtree St NW",c:"Atlanta",z:"30309",la:33.783,ln:-84.393,cp:"ice-vending",cs:["water-refill"],sn:"Ice House America"},
  {n:"Ice House America - Grant Park",a:"530 Boulevard SE",c:"Atlanta",z:"30312",la:33.736,ln:-84.371,cp:"ice-vending",cs:["water-refill"],sn:"Ice House America"},
  {n:"Ice House America - East Atlanta",a:"1275 Glenwood Ave SE",c:"Atlanta",z:"30316",la:33.740,ln:-84.340,cp:"ice-vending",cs:[],sn:"Ice House America"},
  {n:"Ice House America - West End",a:"850 Ralph David Abernathy Blvd SW",c:"Atlanta",z:"30310",la:33.738,ln:-84.412,cp:"ice-vending",cs:[],sn:"Ice House America"},
  {n:"Ice House America - Avondale Estates",a:"21 N Avondale Rd",c:"Avondale Estates",z:"30002",la:33.772,ln:-84.268,cp:"ice-vending",cs:["water-refill"],sn:"Ice House America"},
  {n:"Ice House America - Chamblee",a:"5200 Peachtree Blvd",c:"Chamblee",z:"30341",la:33.883,ln:-84.313,cp:"ice-vending",cs:[],sn:"Ice House America"},
  {n:"Ice House America - Brookhaven",a:"4040 Peachtree Rd NE",c:"Brookhaven",z:"30319",la:33.862,ln:-84.337,cp:"ice-vending",cs:["water-refill"],sn:"Ice House America"},
  // Independent Ice
  {n:"ATL Ice Co - Ponce City",a:"650 N Ave NE",c:"Atlanta",z:"30308",la:33.772,ln:-84.365,cp:"ice-vending",cs:[],sn:"Independent"},
  {n:"Fresh Ice 24/7 - Redan",a:"5310 Redan Rd",c:"Stone Mountain",z:"30088",la:33.747,ln:-84.138,cp:"ice-vending",cs:["water-refill"],sn:"Independent"},
  {n:"Georgia Ice Express - Powder Springs",a:"3660 New Macland Rd",c:"Powder Springs",z:"30127",la:33.860,ln:-84.700,cp:"ice-vending",cs:[],sn:"Independent"},
  {n:"Quick Ice ATL - Ball Ground",a:"405 Valley St",c:"Ball Ground",z:"30107",la:34.339,ln:-84.375,cp:"ice-vending",cs:[],sn:"Independent"},
  {n:"Peach State Ice - Fayetteville",a:"1200 Hwy 85 N",c:"Fayetteville",z:"30214",la:33.465,ln:-84.456,cp:"ice-vending",cs:["water-refill"],sn:"Independent"},

  // === WATER REFILL (~30) ===
  // Primo Water
  {n:"Primo Water - Kroger Sandy Springs",a:"6175 Roswell Rd",c:"Sandy Springs",z:"30328",la:33.938,ln:-84.367,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Walmart Dunwoody",a:"4725 Ashford Dunwoody Rd",c:"Dunwoody",z:"30338",la:33.928,ln:-84.334,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Kroger Johns Creek",a:"11340 Medlock Bridge Rd",c:"Johns Creek",z:"30097",la:34.031,ln:-84.177,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Publix Suwanee",a:"3635 Lawrenceville-Suwanee Rd",c:"Suwanee",z:"30024",la:34.052,ln:-84.069,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Kroger Lilburn",a:"4485 Lawrenceville Hwy",c:"Lilburn",z:"30047",la:33.883,ln:-84.130,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Walmart Tucker",a:"4375 LaVista Rd",c:"Tucker",z:"30084",la:33.849,ln:-84.238,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Kroger Stone Mountain",a:"5370 Memorial Dr",c:"Stone Mountain",z:"30083",la:33.802,ln:-84.190,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Publix Woodstock",a:"6380 Hwy 92",c:"Woodstock",z:"30189",la:34.097,ln:-84.531,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Kroger Acworth",a:"4550 Baker Rd",c:"Acworth",z:"30101",la:34.059,ln:-84.660,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Walmart Jonesboro",a:"7050 Tara Blvd",c:"Jonesboro",z:"30236",la:33.518,ln:-84.353,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Kroger East Point",a:"2615 Camp Creek Pkwy",c:"East Point",z:"30344",la:33.667,ln:-84.470,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Walmart Mableton",a:"5900 Mableton Pkwy",c:"Mableton",z:"30126",la:33.812,ln:-84.565,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Kroger Hampton",a:"1300 Bear Creek Blvd",c:"Hampton",z:"30228",la:33.388,ln:-84.286,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Primo Water - Walmart Locust Grove",a:"4900 Bill Gardner Pkwy",c:"Locust Grove",z:"30248",la:33.348,ln:-84.108,cp:"water-refill",cs:[],sn:"Primo Water"},
  // Watermill Express
  {n:"Watermill Express - Smyrna",a:"2665 Spring Rd SE",c:"Smyrna",z:"30080",la:33.854,ln:-84.496,cp:"water-refill",cs:[],sn:"Watermill Express"},
  {n:"Watermill Express - Vinings",a:"3050 Paces Mill Rd SE",c:"Atlanta",z:"30339",la:33.860,ln:-84.468,cp:"water-refill",cs:[],sn:"Watermill Express"},
  {n:"Watermill Express - College Park",a:"5100 Old National Hwy",c:"College Park",z:"30349",la:33.620,ln:-84.458,cp:"water-refill",cs:[],sn:"Watermill Express"},
  {n:"Watermill Express - Conyers",a:"1340 Dogwood Dr SE",c:"Conyers",z:"30013",la:33.654,ln:-84.020,cp:"water-refill",cs:[],sn:"Watermill Express"},
  {n:"Watermill Express - McDonough Eagles Landing",a:"1615 Eagles Landing Pkwy",c:"McDonough",z:"30253",la:33.428,ln:-84.145,cp:"water-refill",cs:[],sn:"Watermill Express"},
  {n:"Watermill Express - Grayson",a:"2150 Loganville Hwy",c:"Grayson",z:"30017",la:33.895,ln:-83.960,cp:"water-refill",cs:[],sn:"Watermill Express"},
  {n:"Watermill Express - Snellville",a:"2450 Scenic Hwy",c:"Snellville",z:"30078",la:33.857,ln:-84.008,cp:"water-refill",cs:[],sn:"Watermill Express"},
  {n:"Watermill Express - Winder",a:"350 W Athens St",c:"Winder",z:"30680",la:33.990,ln:-83.727,cp:"water-refill",cs:[],sn:"Watermill Express"},
  {n:"Watermill Express - Monroe",a:"880 N Broad St",c:"Monroe",z:"30655",la:33.802,ln:-83.714,cp:"water-refill",cs:[],sn:"Watermill Express"},
  {n:"Watermill Express - Austell",a:"5800 Austell Rd",c:"Austell",z:"30106",la:33.816,ln:-84.641,cp:"water-refill",cs:[],sn:"Watermill Express"},
  {n:"Watermill Express - Redan",a:"5400 Redan Rd",c:"Stone Mountain",z:"30088",la:33.747,ln:-84.135,cp:"water-refill",cs:[],sn:"Watermill Express"},
  {n:"Watermill Express - Chamblee",a:"4920 Peachtree Blvd",c:"Chamblee",z:"30341",la:33.880,ln:-84.310,cp:"water-refill",cs:[],sn:"Watermill Express"},

  // === DRY ICE (~8) ===
  {n:"Penguin Dry Ice - Sandy Springs",a:"5815 Roswell Rd",c:"Sandy Springs",z:"30328",la:33.931,ln:-84.362,cp:"dry-ice",cs:[],sn:"Penguin Dry Ice"},
  {n:"Penguin Dry Ice - Marietta",a:"1230 Roswell Rd",c:"Marietta",z:"30062",la:33.955,ln:-84.462,cp:"dry-ice",cs:[],sn:"Penguin Dry Ice"},
  {n:"Airgas - Buford",a:"4315 Hamilton Mill Rd",c:"Buford",z:"30518",la:34.080,ln:-83.998,cp:"dry-ice",cs:[],sn:"Airgas"},
  {n:"Airgas - Jonesboro",a:"7015 Jonesboro Rd",c:"Jonesboro",z:"30236",la:33.525,ln:-84.362,cp:"dry-ice",cs:[],sn:"Airgas"},
  {n:"Airgas - Woodstock",a:"7200 Hwy 92",c:"Woodstock",z:"30189",la:34.095,ln:-84.524,cp:"dry-ice",cs:[],sn:"Airgas"},
  {n:"Airgas - Kennesaw Barrett",a:"2990 N Cobb Pkwy",c:"Kennesaw",z:"30152",la:34.040,ln:-84.593,cp:"dry-ice",cs:[],sn:"Airgas"},
  {n:"Airgas - Duluth",a:"3175 Breckinridge Blvd",c:"Duluth",z:"30096",la:33.962,ln:-84.143,cp:"dry-ice",cs:[],sn:"Airgas"},
  {n:"Airgas - Conyers",a:"1800 Sigman Rd NE",c:"Conyers",z:"30013",la:33.662,ln:-84.012,cp:"dry-ice",cs:[],sn:"Airgas"},

  // === PROPANE (~8) ===
  {n:"Tractor Supply Propane - Woodstock",a:"7525 Hwy 92",c:"Woodstock",z:"30189",la:34.102,ln:-84.535,cp:"propane-refill",cs:["propane-exchange"],sn:"Tractor Supply"},
  {n:"Tractor Supply Propane - Hampton",a:"1370 Bear Creek Blvd",c:"Hampton",z:"30228",la:33.390,ln:-84.290,cp:"propane-refill",cs:["propane-exchange"],sn:"Tractor Supply"},
  {n:"Tractor Supply Propane - Winder",a:"400 W Athens St",c:"Winder",z:"30680",la:33.991,ln:-83.730,cp:"propane-refill",cs:["propane-exchange"],sn:"Tractor Supply"},
  {n:"Tractor Supply Propane - Monroe",a:"850 N Broad St",c:"Monroe",z:"30655",la:33.801,ln:-83.716,cp:"propane-refill",cs:["propane-exchange"],sn:"Tractor Supply"},
  {n:"U-Haul Propane - Sandy Springs",a:"5900 Roswell Rd",c:"Sandy Springs",z:"30328",la:33.934,ln:-84.364,cp:"propane-refill",cs:[],sn:"U-Haul"},
  {n:"U-Haul Propane - Woodstock",a:"7195 Hwy 92",c:"Woodstock",z:"30189",la:34.094,ln:-84.523,cp:"propane-refill",cs:[],sn:"U-Haul"},
  {n:"U-Haul Propane - Stockbridge Eagle",a:"4050 Eagles Landing Pkwy",c:"Stockbridge",z:"30281",la:33.525,ln:-84.220,cp:"propane-refill",cs:[],sn:"U-Haul"},
  {n:"AmeriGas Propane - Winder",a:"460 W Athens St",c:"Winder",z:"30680",la:33.988,ln:-83.733,cp:"propane-refill",cs:["propane-exchange"],sn:"AmeriGas"},

  // === CONVENIENCE STORES (~8) ===
  {n:"Buc-ee's - Calhoun I-75",a:"601 Union Grove Rd SE",c:"Calhoun",z:"30701",la:34.430,ln:-84.935,cp:"convenience-store",cs:["beer-drinks"],sn:"Buc-ee's"},
  {n:"QuikTrip - Brookhaven",a:"3650 Peachtree Rd NE",c:"Brookhaven",z:"30319",la:33.854,ln:-84.339,cp:"convenience-store",cs:["beer-drinks"],sn:"QuikTrip"},
  {n:"QuikTrip - Sandy Springs",a:"6080 Roswell Rd",c:"Sandy Springs",z:"30328",la:33.937,ln:-84.366,cp:"convenience-store",cs:["beer-drinks"],sn:"QuikTrip"},
  {n:"RaceTrac - Suwanee",a:"3440 Lawrenceville-Suwanee Rd",c:"Suwanee",z:"30024",la:34.049,ln:-84.070,cp:"convenience-store",cs:["beer-drinks"],sn:"RaceTrac"},
  {n:"RaceTrac - Jonesboro",a:"6905 Tara Blvd",c:"Jonesboro",z:"30236",la:33.523,ln:-84.356,cp:"convenience-store",cs:["beer-drinks"],sn:"RaceTrac"},
  {n:"Circle K - Dunwoody",a:"4630 Ashford Dunwoody Rd",c:"Dunwoody",z:"30338",la:33.926,ln:-84.332,cp:"convenience-store",cs:["beer-drinks"],sn:"Circle K"},
  {n:"Circle K - Woodstock",a:"7350 Hwy 92",c:"Woodstock",z:"30189",la:34.099,ln:-84.529,cp:"convenience-store",cs:["beer-drinks"],sn:"Circle K"},
  {n:"Circle K - Lithonia",a:"6800 Main St",c:"Lithonia",z:"30058",la:33.712,ln:-84.102,cp:"convenience-store",cs:["beer-drinks"],sn:"Circle K"},

  // === PACKAGE STORES (~6) ===
  {n:"Sandy Springs Bottle Shop",a:"6100 Roswell Rd",c:"Sandy Springs",z:"30328",la:33.939,ln:-84.368,cp:"package-store",cs:["beer-drinks"],sn:"GA Alcohol License"},
  {n:"Woodstock Wine & Spirits",a:"7280 Hwy 92",c:"Woodstock",z:"30189",la:34.096,ln:-84.526,cp:"package-store",cs:["beer-drinks"],sn:"GA Alcohol License"},
  {n:"East Atlanta Beer & Wine",a:"1285 Glenwood Ave SE",c:"Atlanta",z:"30316",la:33.741,ln:-84.339,cp:"package-store",cs:["beer-drinks"],sn:"GA Alcohol License"},
  {n:"Jonesboro Package Store",a:"6950 Tara Blvd",c:"Jonesboro",z:"30236",la:33.519,ln:-84.354,cp:"package-store",cs:["beer-drinks"],sn:"GA Alcohol License"},
  {n:"Lilburn Wine & Spirits",a:"4300 Lawrenceville Hwy",c:"Lilburn",z:"30047",la:33.884,ln:-84.128,cp:"package-store",cs:["beer-drinks"],sn:"GA Alcohol License"},
  {n:"Suwanee Spirits",a:"3650 Lawrenceville-Suwanee Rd",c:"Suwanee",z:"30024",la:34.053,ln:-84.071,cp:"package-store",cs:["beer-drinks"],sn:"GA Alcohol License"},

  // Additional Ice & Water
  {n:"Twice the Ice - Redan",a:"5280 Redan Rd",c:"Stone Mountain",z:"30088",la:33.745,ln:-84.140,cp:"ice-vending",cs:["water-refill"],sn:"Twice the Ice"},
  {n:"Watermill Express - Doraville",a:"6015 Buford Hwy",c:"Doraville",z:"30340",la:33.900,ln:-84.288,cp:"water-refill",cs:[],sn:"Watermill Express"},
  {n:"Primo Water - Publix Vinings",a:"3080 Paces Mill Rd",c:"Atlanta",z:"30339",la:33.863,ln:-84.469,cp:"water-refill",cs:[],sn:"Primo Water"},
  {n:"Kooler Ice - Conyers",a:"1360 Dogwood Dr SE",c:"Conyers",z:"30013",la:33.655,ln:-84.021,cp:"ice-vending",cs:["water-refill"],sn:"Kooler Ice"},
  {n:"Ice House America - Smyrna",a:"2680 Spring Rd SE",c:"Smyrna",z:"30080",la:33.855,ln:-84.497,cp:"ice-vending",cs:[],sn:"Ice House America"},

  // ============================================================
  // NEW RURAL GEORGIA LOCATIONS (100)
  // ============================================================
...
const getWebsite = (sn) => {
  const sites = {
    ...
    'Flash Foods': 'https://flashfoods.com',
...
const getSourceUrl = (sn) => {
  const urls = {
    ...
    'Watermill Express': 'https://watermillexpress.com/locations',
    'Penguin Dry Ice': 'https://penguindryice.com',
    'Ice House America': 'https://icehouseamerica.com/locations',
    'Tractor Supply': 'https://tractorsupply.com/tsc/store-finder',
    "Buc-ee's": 'https://buc-ees.com/locations',
    'Flash Foods': 'https://flashfoods.com/stores',
    "Parker's": 'https://parkersav.com/locations',
  };
  return urls[sn] || '';
};
